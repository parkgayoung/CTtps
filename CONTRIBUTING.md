...
* [Submit a post for your issue](https://github.com/parkgayoung/CTtps/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/parkgayoung/CTtps/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:

    `git clone git@github.com:your-username/CTtps.git`
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/parkgayoung/CTtps/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/parkgayoung/CTtps/compare/).
...
* Engage in discussion on [your issue](https://github.com/parkgayoung/CTtps/issues/).
