...
>>>>>>> 76d250fbb5bf37e72d7f72654f54663a37cb55a7
...
```{r}
#| label: tab-landmark-abbreviations

<<<<<<< HEAD
here::here("analysis/data/raw_data/table-of-landmark-abbreviations.csv") %>% 
  read_csv() %>% 
  knitr::kable(., caption = "Description of artefact landmarks used in this study")
...
(ref:cap-fig-plot-cv-all-attributes) A: Boxplot for each attribute measured on the stemmed points. The black bold horizontal lines in the middle of boxes represent the median value. The dots represent individual artefacts. B: The points and blue colored numbers represent CV values for each attribute measured on the stemmed points. 95 p confidence intervals for the CVs were computed using Sharma and Krishna's method. The vertical lines indicate the range of confidence intervals. 

```{r}
#| label: fig-plot-cv-all-attributes
#| fig-cap: '(ref:cap-fig-plot-cv-all-attributes)'
#| fig-width:   7
#| fig-height:  4
