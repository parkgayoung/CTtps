...
```{r}
#attributes of the points by calculating distance between landmakrs
...
Correlation, Coefficient or variation, PCA
```{r}
...
autoplot(prcomp(DF), data = df_sitename, colour = 'sitename')

ggbiplot(PCA, obs.scale = 1, var.scale = 1,          ellipse = TRUE, circle = TRUE)+
scale_color_discrete (name = '') + groups (df$files)
  theme(legend.direction = 'horizontal', legend.position = 'top')

#https://towardsdatascience.com/principal-component-analysis-pca-101-using-r-361f4c53a9ff <- another way of PCA, relationship with two variables
...
###I need to figure out how to group them  -- by phase?
...
lm_landmarks <- readalltps(here("analysis/data/raw_data"))
