...
```
=> We may need to delete this chunk since we made 
...
cv_all <- fviz_pca_var(xx_pca, col.var = "contrib",
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), title ="All")

# phase 2
cv_two <- fviz_pca_var(xx_pca2, col.var = "contrib",
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), title ="Phase 2")
# phase 3
cv_three <- fviz_pca_var(xx_pca3, col.var = "contrib",
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), title ="Phase 3")
...
cSYG6_DF <- rplot(corrr_SYG6_DF) +
  ggtitle("Correlation for corrr_SYG6_DF, 2nd phase") 
...
cv_SYG6 <-fviz_pca_var(SYG6_xx_pca, col.var = "contrib",
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), title ="SYG6:2nd")
...
cSYG1_2DF <- rplot(corrr_SYG1_2DF) +
  ggtitle("Correlation for corrr_SYG1_2DF, 3rd phase") 
...
cv_SYG1_2 <- fviz_pca_var(SYG1_2xx_pca, col.var = "contrib",
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), title ="SYG1_2:3rd")


SYG1_2PC1_v <- fviz_contrib(SYG_1xx_pca, choice = "var", axes = 1, top = 7)
SYG1_2PC2_v <- fviz_contrib(SYG_1xx_pca, choice = "var", axes = 2, top = 7)
...
cSYG1_1DF <- rplot(corrr_SYG1_1DF) +
  ggtitle("Correlation for corrr_SYG1_1DF, 2nd phase") 
...
cv_SYG1_1 <-fviz_pca_var(SYG1_1xx_pca, col.var = "contrib",
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), title ="SYG1_1:2nd")


SYG1_1PC1_v <- fviz_contrib(SYG_1xx_pca, choice = "var", axes = 1, top = 7)
SYG1_1PC2_v <- fviz_contrib(SYG_1xx_pca, choice = "var", axes = 2, top = 7)
