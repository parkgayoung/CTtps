...
<!-- BM: You'll see I've completely removed the PCA content. I did some more reading into what PCA calculates, and it is not correlation coefficients of the variables with each other, but with the Principal Components that it calculates. So that's a very different kind of correlation, compared to what we see in the previous literature on transmission biases. I suppose we could use it and interpret it, if you want to investigate that further. I could not think of anything straightforward over the several days I have been editing this. I saw that you did not give them the same treatment as the CV values with exploring variation by raw material and by site, so I guess you were not very interested in the PCA results. My perspective is that we should look for the quickest and simplest way to complete this paper. So I have replaced the PCA with the same kind of correlation analysis that we see elsewhere so we can use the previously published papers to guide our interpretation of our results -->

<!-- BM: GP to write up the correlation coefficients results in detail, according to what you see in the plot made by the code below. I've already done all the analysis here. Your task is to describe it here, and then contextualise and interpret it in the next section. Use this paper as a template for how detailed you need to be here: "Point Typologies, Cultural Transmission, and the Spread of Bow-and-Arrow Technology". Aim for a style of writing that is detailed, direct, specific, short sentences.  -->
