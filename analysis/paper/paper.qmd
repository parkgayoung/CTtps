...
#| fig-cap: CV values of four attributes from assemblages with more than 5 stemmed points. Among the four assemblages, SYG1_2 and SYG6_2 are from Phase 2 of the Korean Late Paleolithic chronology and SYG1_3 and YS_3 are from Phase 3.
#| fig-width:   4.5
#| fig-height:  4
...
<!-- GP to write up the results in detail, that you see in the plot made by the code below. Use this paper as a template for how detailed you need to be here: "Point Typologies, Cultural Transmission, and the Spread of Bow-and-Arrow Technology" -->

```{r}
#| label: fig-corr-analysis
#| fig-cap: Correlation analysis of point attributes, calculated using Pear
#| fig-width:   7
#| fig-height:  4
