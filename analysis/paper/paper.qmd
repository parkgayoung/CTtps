...
We conclude that the dominant mode of cultural transmission for the earliest stemmed points was guided variation (trial and error). This is indicated by relatively high CV values of around and above `r threshold_value` and mostly low correlation coefficients of less than `r threshold_value_cor`. 




A social context that favoured trial and error for artifact making is consistent with Seong's *in situ* model for the appearance of stemmed points in Korea. This model proposes that people developed stemmed points by experimenting with existing blade technologies. Our results support experimentation and trial and error as important processes in the cultural transmission of this artifact technology.
