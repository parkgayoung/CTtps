...
#| fig-cap: A. Correlation for each site that has more than five stemmed points. B. Correlation for raw materials that were used for making more than one stemmed poitns. The grey points represent correlation between two attributes.
